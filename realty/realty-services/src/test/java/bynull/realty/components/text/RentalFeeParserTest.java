...
public class RentalFeeParserTest {
    ...
    @Ignore("zero value case. fix it later")
    @Test
    ...
    @Ignore("zero value case - fit it later")
    @Test
    public void fixBug_64_comment_11_plus_35() throws Exception {
        ...
        assertThat(parser.findRentalFee(text), equalTo(new BigDecimal("800000")));
    }
    ...
    public void fixBug_64_comment_11_plus_36() throws Exception {
        ...
        final String text =
                "сниму ГАРАЖ (желательно теплый)в районе метро Выхино,Лермонтовский\n" +
                        "            проспект,Жулебино,Котельники,Щелковская.Бюджет до 3 500 т.р.";
        assertThat(parser.findRentalFee(text), is("3500"));
    }
