...
public class MetroTextAnalyzerTest {
    ...
    public void success() {
        ...
        assertThat(analyzer.matches("Сдается квартира недалеко от станции Улицы Старокачаловской", metroName), is(true));
        assertThat(analyzer.matches("Сдается квартира недалеко от станции ул. Старокачаловской", metroName), is(true));
