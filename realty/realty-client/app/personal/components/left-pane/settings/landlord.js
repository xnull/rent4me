...
//            console.log(location);
    ...
    render: function () {
        ...
        var addressPreviewProp = {
            ...
            customClassName: 'col-md-8 col-sm-8 col-xs-8',
            labelClass: 'col-md-4 col-sm-4 col-xs-4'
        };
        ...
        var submitButton = {
            ...
            value: 'Отправить',
            customClassName: 'col-md-4 col-sm-4 col-xs-4 col-md-offset-4 col-sm-offset-4 col-xs-offset-4'
        };
...
var UserPreview = React.createClass({
    render: function () {
        var customClassName = this.props.data.customClassName || 'col-md-4 col-sm-4 col-xs-4';
        var label = this.props.data.labelClass || "col-md-3 col-sm-3 col-xs-3 " + " control-label";
...
var UserCheckbox = React.createClass({
    render: function () {
        ...
        return (
            <div>
                <div className="form-group">
                    <label className="col-md-3 col-sm-3 col-xs-3 control-label">
...
var UserSelect = React.createClass({
    render: function () {
        ...
        return (
            <div>
                <div className="form-group">
                    <label className="col-md-3 col-sm-3 col-xs-3 control-label">{this.props.data.name}</label>
                    <div className={customClassName}>
                        <select
                            id={this.props.data.id}
                            className="form-control"
...
//        changeTransient(this, assign(this.state.transient, {selectedPhoto: {photo:{full_picture_url: 'images/spin.gif' }}}))
    ...
    render: function () {
        ...
        var addressPreviewProp = {
            ...
            name: 'Выбранный адрес',
            previewValue: (data['address'] ? data['address']['formatted_address'] : null) || '',
            customClassName: 'col-md-10 col-sm-10 col-xs-10',
            labelClass: 'col-md-2 col-sm-2 col-xs-2'
        };
        ...
        var rentalFeeProp = {
            ...
            labelClass: 'col-md-3 col-sm-3 col-xs-3'
        };
        var feePeriodProp = {
            id: 'feePeriod',
            name: 'Оплата',
        ...
        var publishedProp = {
            id: 'published',
            name: 'Опубликовано',
            customClassName: 'col-md-4 col-sm-4 col-xs-4 col-md-offset-1 col-sm-offset-1 col-xs-offset-1',
        ...
        var deleteButton = {
            ...
            value: 'Удалить',
            customClassName: 'col-md-2 col-sm-2 col-xs-2 col-md-offset-8 col-sm-offset-8 col-xs-offset-8',
            type: 'btn-danger'
        };
        ...
        var submitButton = {
            id: 'saveApartmentBtn',
            value: 'Сохранить',
            customClassName: 'col-md-2 col-sm-2 col-xs-2',
            type: 'btn-primary'
        };
