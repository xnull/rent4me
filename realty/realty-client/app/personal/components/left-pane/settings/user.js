        ...
        return (
            <div>
                <div className="form-group">
                    <label className="col-md-2 col-sm-2 col-xs-2 control-label">{this.props.data.name}:</label>
...
var UserButton = React.createClass({
    render: function () {
        var customClassName = this.props.data.customClassName || 'col-md-2 col-sm-2 col-xs-2 col-md-offset-4 col-sm-offset-4 col-xs-offset-4';
