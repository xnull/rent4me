...
//    console.log(apartmentObject);
    ...
    switch(action.actionType) {
        case SocialNetConstants.SOCIAL_NET_LESSOR_POSTS_FOUND:
        ...
        case SocialNetConstants.SOCIAL_NET_LESSOR_POSTS_SAVE_SEARCH_TEXT:
            _searchText = action.text || null;
            return true;//don't emit any event
            break;

        case SocialNetConstants.SOCIAL_NET_LESSOR_POSTS_SAVE_SEARCH_WITH_SUBWAY:
