                      ...
                      <div className="modal-body">
                          ...
                          <div className="tab-content">
                              ...
                              <div className="tab-pane active" id="tab-login">
                                  ...
                                  <form name="loginform" id="loginform" action="http://demo.themetrail.com/realty/wp-login.php"
                                        method="post">

                                      <p className="login-username">
                                          <label htmlFor="user_login"></label>
                                          <input type="text" name="log" id="user_login" className="input" value="" size="20" placeholder="Username or em@il"/>
                                      </p>
                                      <p className="login-password">
                                          <label htmlFor="user_pass"></label>
                                          <input type="password" name="pwd" id="user_pass" className="input" value="" size="20" placeholder="Password"/>
                                      </p>

                                      <p className="login-remember"><label><input name="rememberme" type="checkbox" id="rememberme"
                                                                              value="forever"/> Remember Me</label></p>
                                      <p className="login-submit">
                                          <input type="submit" name="wp-submit" id="wp-submit-login" className="button-primary"
                                                 value="Log In"/>
                                          <input type="hidden" name="redirect_to" value="http://demo.themetrail.com/realty/"/>
                                      </p>
