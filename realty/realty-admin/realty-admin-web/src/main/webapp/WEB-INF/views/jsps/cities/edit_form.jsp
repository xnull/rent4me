...
<form role="form" method="post" id="cityForm">
    <div class="form-group">
        <label for="id">#</label>
        <input type="hidden" class="form-control" name="id" placeholder="#" value="${city.id}" readonly>
        <input type="text" class="form-control" id="id" placeholder="#" value="${city.id}" readonly>
    </div>
    <div class="form-group">
        <label for="name">name</label>
        <input type="text" class="form-control" name="name" id="name" placeholder="City name" value="${city.name}">
    </div>
    <div class="form-group" style="display: none">
        <label for="name">High Lat</label>
        <input type="text" class="form-control" name="area.high.latitude" id="area.high.latitude"
               placeholder="area.high.latitude" value="${city.area.high.latitude}" readonly="readonly">
    </div>
    <div class="form-group"style="display: none">
        <label for="name">High Lng</label>
        <input type="text" class="form-control" name="area.high.longitude" id="area.high.longitude"
               placeholder="area.high.longitude" value="${city.area.high.longitude}" readonly="readonly">
    </div>
    <div class="form-group" style="display: none">
        <label for="name">Low Lat</label>
        <input type="text" class="form-control" name="area.low.latitude" id="area.low.latitude"
               placeholder="area.low.latitude" value="${city.area.low.latitude}" readonly="readonly">
    </div>
    <div class="form-group" style="display: none">
        <label for="name">Low Lng</label>
        <input type="text" class="form-control" name="area.low.longitude" id="area.low.longitude"
               placeholder="area.low.longitude" value="${city.area.low.longitude}" readonly="readonly">
    </div>
