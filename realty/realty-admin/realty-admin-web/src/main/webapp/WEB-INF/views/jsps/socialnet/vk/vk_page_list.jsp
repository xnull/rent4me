...
<div>
    ...
    <p>
        <a href="<c:url value="/secure/socialnet/vk/new"/>" class="btn btn-primary"><i
                class="glyphicon glyphicon-plus"></i> Add Page</a><br/>
    </p>

    <%--<p>--%>
    <%--<a href="<c:url value="/secure/socialnet/vk/posts"/>" class="btn btn-default"><i--%>
    <%--class="glyphicon glyphicon-th-list"></i> VK Posts</a><br/>--%>
    <%--</p>--%>
</div>
<table class="table table-striped">
    ...
    <c:forEach var="page" items="${pages}">
        <tr>
            ...
            <td>
                <a class="btn btn-default" href="<c:url value="/secure/socialnet/vk/${page.id}/edit"/>"><i
