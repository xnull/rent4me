    ...
    <c:forEach var="post" items="${posts}">
        <tr>
            ...
            <td>
                ...
                <a href="<c:url value="/secure/socialnet/fb/${post.page.id}/edit"/>"><i class="glyphicon glyphicon-edit"></i></a>
                <a href="${post.page.link}" target="_blank"><i class="glyphicon glyphicon-link"></i></a>
            </td>
            <td>
                <ul>
